...
import { Calendar, ChevronsUpDown, ChevronDown, ChevronUp, MessageSquare, Mic, Play, Pause, SkipForward, SkipBack, X, Activity } from "lucide-react";
    ...
    return (
        ...
        <div className="animate-in fade-in duration-700 p-6 space-y-3">
            ...
            <div className="bg-white dark:bg-slate-900/50 rounded-[20px] border border-slate-200/70 dark:border-slate-800 shadow-[0_10px_28px_-8px_rgba(15,23,42,0.18),0_4px_10px_-2px_rgba(15,23,42,0.08)] dark:shadow-[0_10px_28px_-6px_rgba(0,0,0,0.55),0_4px_10px_-2px_rgba(0,0,0,0.35)] flex flex-col overflow-hidden">
                ...
                <PaginationFooter
                    totalLabel={t("call_logs_page.results_found", { count: logsResponse?.total || 0 })}
                    rowsLabel={t("call_logs_page.show_label")}
                    rowsOptions={[10, 25, 50]}
                    rowsPerPage={rowsPerPage}
                    onRowsPerPageChange={(n) => { setRowsPerPage(n); setPage(1); }}
                    page={page}
                    totalPages={totalPages || 1}
                    pagePrefixLabel={t("call_logs_page.page_label")}
                    pageOfLabel={t("call_logs_page.of_label")}
