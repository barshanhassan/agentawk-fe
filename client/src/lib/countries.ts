export const COUNTRIES = [
  ...
  { name: "Bonaire, Sint Eustatius and Saba", code: "BQ", dial: "+599" },
  ...
  { name: "Congo, Democratic Republic of the Congo", code: "CD", dial: "+243" },
  { name: "Cook Islands", code: "CK", dial: "+682" },
  { name: "Costa Rica", code: "CR", dial: "+506" },
  { name: "Cote D'Ivoire", code: "CI", dial: "+225" },
  { name: "Croatia", code: "HR", dial: "+385" },
  { name: "Cuba", code: "CU", dial: "+53" },
  { name: "Curacao", code: "CW", dial: "+599" },
  ...
  { name: "Iran, Islamic Republic of", code: "IR", dial: "+98" },
  ...
  { name: "Korea, Democratic People's Republic of", code: "KP", dial: "+850" },
  { name: "Korea, Republic of", code: "KR", dial: "+82" },
  { name: "Kosovo", code: "XK", dial: "+383" },
  { name: "Kuwait", code: "KW", dial: "+965" },
  { name: "Kyrgyzstan", code: "KG", dial: "+996" },
  { name: "Lao People's Democratic Republic", code: "LA", dial: "+856" },
  ...
  { name: "Macedonia, the Former Yugoslav Republic of", code: "MK", dial: "+389" },
  ...
  { name: "Northern Mariana Islands", code: "MP", dial: "+1" },
  ...
  { name: "Russian Federation", code: "RU", dial: "+7" },
  ...
  { name: "Serbia and Montenegro", code: "CS", dial: "+381" },
  ...
  { name: "Taiwan, Province of China", code: "TW", dial: "+886" },
  { name: "Tajikistan", code: "TJ", dial: "+992" },
  { name: "Tanzania, United Republic of", code: "TZ", dial: "+255" },
  ...
  { name: "Turks and Caicos Islands", code: "TC", dial: "+1" },
  ...
  { name: "Viet Nam", code: "VN", dial: "+84" },
  { name: "Virgin Islands, British", code: "VG", dial: "+1" },
  { name: "Virgin Islands, U.s.", code: "VI", dial: "+1" },
