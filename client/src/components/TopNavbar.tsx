      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem
              className="flex items-center gap-3 px-2 py-2 rounded-lg cursor-pointer hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary transition-colors"
            ...
            <DropdownMenuItem
              className="flex items-center gap-3 px-2 py-2 rounded-lg cursor-pointer text-red-500 hover:bg-red-50 dark:hover:bg-red-950/20 focus:bg-red-50 dark:focus:bg-red-950/20 transition-colors"
