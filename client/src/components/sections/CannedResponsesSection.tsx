    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-start justify-between border-b pb-6">
        <div className="flex gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold tracking-tight text-foreground">Canned Responses</h2>
            <p className="text-sm text-muted-foreground mt-1 text-slate-500">
              Efficiently create and organize canned responses for live chats with leads or contacts.
            </p>
          </div>
        </div>
