                ...
                <div className="flex items-center gap-2">
                    ...
                    <Popover open={createdAtOpen} onOpenChange={setCreatedAtOpen}>
                        <PopoverTrigger asChild>
                            <button className="h-9 px-3 flex items-center gap-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all text-[11px] font-medium text-slate-600 dark:text-slate-300 shadow-sm border-0">
                    ...
                    <div className="relative" ref={sortDropdownRef}>
                        <Button
                            ...
                            variant="outline"
                            className={cn(
                                "h-9 px-3 rounded-xl text-[11px] font-bold border border-slate-200 dark:border-slate-800 shadow-sm",
