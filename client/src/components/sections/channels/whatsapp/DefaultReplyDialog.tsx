...
const INTERVAL_OPTIONS = [
  { value: "0", label: "Trigger once", description: "The default reply runs the first time this contact messages this number, ever." },
  { value: "24", label: "Once every 24 hours", description: "The default reply runs at most once per 24 hour window per contact." },
  { value: "247", label: "Trigger always", description: "The default reply runs on every inbound message from this contact." },
];
